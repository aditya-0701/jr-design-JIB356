...
export const ProjectSelector = ({ navigation }) => {
  ...
  return (
    <View id="page1" style={[style.container, {flex: 1}]}>
      ...
      <Text style={styles.title}>{projectDetails.name}</Text>
      <Text style={styles.label}>{projectDetails.description}</Text>
...
export const ProjectExtended = ({ navigation }) => {
  ...
  return (
    <View id="page2" style={[style.container, {flex: 1}]}>
      ...
      <Text style={styles.title}>{projectDetails.name}</Text>
      <Text style={styles.label}>{projectDetails.description}</Text>
      <Text style={styles.label}>Skills: {projectDetails.skills}</Text>
      <Text style={styles.label}>Hours Per Week: {projectDetails.hoursPerWeek}</Text>
      <Text style={styles.label}>Link: {projectDetails.externalLink}</Text>
    </View>
  );
};
